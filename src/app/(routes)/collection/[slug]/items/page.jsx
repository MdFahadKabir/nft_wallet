...
import { BadgeCheck, LayoutGrid, List, ShoppingCart, SlidersHorizontal } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
                ...
                <Accordion type="single" collapsible className="w-full mt-2">
                  ...
                  >
                    ...
                    <AccordionContent className="text-xs space-y-4">
                      <div className="flex items-center space-x-2 mx-1 my-2">
                ...
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute -bottom-2 w-full  pt-2 bg-[#281D3A] backdrop-blur-lg rounded-b-xl">
                      <p className="text-sm font-semibold px-3  pb-2">
                        {item.name}
                      </p>
                      {hoveredItem !== index && (
                        <div>
                      ...
                      {hoveredItem === index && (
                        <button className="flex justify-center items-center gap-2 bg-[#D500E7] w-full rounded-b-xl px-2 py-3.5">
                          ...
                          <p className="text-sm text-semibold"> Add to cart</p>
                        </button>
                      )}
                    </div>
                  </div>
